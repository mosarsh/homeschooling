...
[![Go Report Card](https://goreportcard.com/badge/github.com/mosarsh/homeschooling)](https://goreportcard.com/report/github.com/mosarsh/homeschooling)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/mosarsh/homeschooling-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/mosarsh/homeschooling` to `$GOPATH/github.com/author/project`. We use [task](https://github.com/go-task/task) as a task runner. Run ``task relocate`` to rename the packages, e.g. ``task relocate TARGET=github.com/author/project``
